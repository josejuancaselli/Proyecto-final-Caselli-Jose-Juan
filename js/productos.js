...
const crearProductos = async (arrayRopa) => { // aca entra la categoria que me traje
    const respuesta = await fetch("/proyecto-final-caselli-jose-juan/json/productos.json");
...
btnLinkCarrito.addEventListener("click", () => {
    window.location.href = "/proyecto-final-caselli-jose-juan/pages/carrito.html";
})
